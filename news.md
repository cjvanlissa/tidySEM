...
* Fixed bug where multiple columns called "label" were generated by mplus and
  lavaan, which overlap with the "label" column used for plotting. Renamed 
  other "label" columns to "mplus_label" and "lavaan_label"
* graph_sem(fix_coord = TRUE) now works for multi-group models too
