...
> Van Lissa, C. J., (2019). *tidySEM: A tidy workflow for running, reporting, and plotting structural equation models in lavaan or Mplus.* R package version 0.1.4. https://github.com/cjvanlissa/tidySEM/
...
By participating in this project, you agree to abide by the [Code of Merit](https://codeofmerit.org/CODE_OF_CONDUCT.md).
