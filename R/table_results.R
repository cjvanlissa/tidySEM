...
#' @export
table_results.rma <-  function(x, standardized = TRUE, columns = c("label", "est_sig", "se", "pval", "confint", "group", "level"), digits = 2, ...){
...
#' @examples
#' #Make me!
table_results <- function(x, standardized = TRUE, columns = c("label", "est_sig", "se", "pval", "confint", "group", "level"), digits = 2, ...){
  UseMethod("table_results")
}

#' @method table_results mplusObject
#' @export
table_results.mplusObject <- function(x, standardized = TRUE, columns = c("label", "est_sig", "se", "pval", "confint", "group", "level"), digits = 2, ...){
...
#' @export
table_results.mplus.model <- function(x, standardized = TRUE, columns = c("label", "est_sig", "se", "pval", "confint", "group", "level"), digits = 2, ...){
  Args <- list(x = x)
  digits <- force(digits)
...
#' @export
table_results.lavaan <- function(x, standardized = TRUE, columns = c("label", "est_sig", "se", "pval", "confint", "group", "level"), digits = 2, ...){
