...
run_everything = isTRUE(getOption("run_everything"))
```
...
p <- ggplot(df_plot, aes(x = Value)) +
  ...
  facet_wrap(~Variable)+
  theme_bw()
ggsave("appendices/plot_gmm_desc.png", p, device = "png", width = 100, height = 100, units = "mm")
```
...
df_plot <- reshape(df_plot, varying = names(df_plot), direction = "long",
                   timevar = "Variable")
knitr::include_graphics("appendices/plot_gmm_desc.png")
```
...
p <- ggplot(df_plot, aes(x = Value)) +
  ...
  facet_wrap(~Variable)+
  theme_bw()
ggsave("appendices/plot_gmm_desc_log.png", p, device = "png", width = 100, height = 100, units = "mm")
```
```{r figdesclog, echo = FALSE, eval = TRUE}
knitr::include_graphics("appendices/plot_gmm_desc_log.png")
```
...
p <- ggplot(df, aes(x = length, y = width)) +
  geom_point(alpha = .1) +
  theme_bw()
ggsave("appendices/plot_gmm_scatter.png", p, device = "png", width = 100, height = 100, units = "mm")
```
```{r figscatter, eval = TRUE, echo = FALSE}
knitr::include_graphics("appendices/plot_gmm_scatter.png")
```
...
ggsave("appendices/gmm_plotfit.png", p, device = "png", width = 100, height = 100, units = "mm", scale = 1)
```
```{r echo = FALSE, eval = TRUE, fig.cap="Bivariate profile plot", out.width="100%"}
knitr::include_graphics("appendices/gmm_plotfit.png")
```
...
ggsave("appendices/gmm_bivariate_bic.png", p, device = "png", width = 210, height = 100, units = "mm", scale = 1.5)
```
```{r echo = FALSE, eval = TRUE, fig.cap="Bivariate profile plot", out.width="100%"}
knitr::include_graphics("appendices/gmm_bivariate_bic.png")
```
