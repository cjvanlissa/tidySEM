...
saveRDS(results, "gmm_results.RData")
```
```{r eval = TRUE, echo = FALSE}
results <- readRDS("gmm_results.RData")
...
ggsave("gmm_bivariate_bic.svg", p, device = "svg", width = 210, height = 100, units = "mm", scale = 1.5)
```
```{r echo = FALSE, eval = pkgdown, fig.cap="Bivariate profile plot", out.width="100%"}
knitr::include_graphics("gmm_bivariate_bic.svg")
```
