...
if("build_site" %in% unlist(as.character(lapply(sys.calls(), `[[`, 1)))){
  knitr::opts_chunk$set(
  results = "markup"
)
}
...
# Get fit table fit
tab_fit <- readRDS("lcga_fit.RData")
...
```
```{r waldtests, echo = FALSE, eval = TRUE}
