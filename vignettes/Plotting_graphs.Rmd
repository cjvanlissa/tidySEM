...
1. Manually in R
2. Automatically, from the fit model
...
graph_sem(model = fit, layout = lay, text_size = 2, fix_coord = TRUE)
```
...
* `alpha`: The transparancy of the line (e.g., `alpha = 1` or `alpha = .2`)
...
* `size`: The size of the line (e.g., `size = 1` or `size = 2`)
* `alpha`: The transparancy of the node (e.g., `alpha = 1` or `alpha = .2`)
...
* `label_alpha`: The transparancy of the label (e.g., `alpha = 1` or `alpha = .2`)
